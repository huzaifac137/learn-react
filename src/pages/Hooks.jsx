...
function Hooks(){
    return (
        ...
        <Step descriptionContent={`Hooks allows you manipulate React state and lifecycle in function components. Hooks don't work inside classes. 
         ...
         \n => useCallback \n \n => useContext \n`}
       descriptionContentEnd={` Hooks can only be used inside of a functional Component \n \n We will discuss first three in details in next portion and others also in some part of the course `} /> 
